...
RUN wget https://repo.teaspeak.de/server/linux/amd64_optimized/TeaSpeak-1.3.17-beta.tar.gz &&\
	tar -xzf TeaSpeak-1.3.17-beta.tar.gz &&\
	rm TeaSpeak-1.3.17-beta.tar.gz
