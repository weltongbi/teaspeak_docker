...
RUN apt-get update -y &&\
        ...
        wget https://repo.teaspeak.de/server/linux/amd64_optimized/TeaSpeak-1.4.2-beta-1.tar.gz &&\
        tar -xzf TeaSpeak-1.4.2-beta-1.tar.gz &&\
        rm TeaSpeak-1.4.2-beta-1.tar.gz &&\
        ./install_libnice.sh &&\
